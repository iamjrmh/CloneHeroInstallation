...
3. Rescan or reopen Clone Hero and your new content will be available.
...
3. Right-click the song's `.zip` file and select **Send with Blip**, then select your iPhone from the list.
4. On your iPhone, the file will be auto-accepted. Tap it and select **Open with Files**. Then tap and hold the file and press **Move**.
5. Navigate to **LiveContainer → Data → Application → [your Clone Hero folder]** (from step 6 of Installing Clone Hero) **→ Documents → Songs**, then tap **Move** to confirm.
6. In the Songs folder, tap the zipped file to unzip it, then delete the original `.zip`.
7. Close the Files app, reopen Clone Hero, and rescan your library. Your new song should appear.
...
3. Right-click the `.zip` and select **Send with Blip**, then select your iPhone.
4. On your iPhone, tap the received file and select **Open with Files**. Tap and hold it and press **Move**.
5. Navigate to **LiveContainer → Data → Application → [your Clone Hero folder] → Documents → Custom**, then into the appropriate subfolder for your content type (**Colors**, **Backgrounds**, or **Highways**). Tap **Move** to confirm.
6. Tap the zipped file to unzip it, then delete the original `.zip`.
7. Close the Files app, reopen Clone Hero, and rescan. Your new content will be available.
...
2. Download your desired song(s) on your PC.
3. Right-click the song's `.zip` file and select **Send with Blip**, then select your device from the list.
4. On your device, the file will be auto-accepted. Tap it and select **Open with File Manager**. Tap and hold the file and press **Move**.
5. Navigate to **Documents > Clone Hero > Songs** and confirm the move.
6. Tap the zipped file in the Songs folder to unzip it, then delete the original `.zip`.
7. Reopen Clone Hero and rescan your library. Your new song should appear.
...
3. Right-click the `.zip` and select **Send with Blip**, then select your device.
4. On your device, tap the received file and select **Open with File Manager**. Tap and hold it and press **Move**.
5. Navigate to **Documents > Clone Hero > Custom** and into the subfolder for your content type (**Colors**, **Backgrounds**, or **Highways**). Confirm the move.
6. Tap the zipped file to unzip it, then delete the original `.zip`.
7. Reopen Clone Hero and rescan. Your new content will be available.
